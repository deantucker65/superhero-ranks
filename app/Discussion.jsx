...
// Per-actor discussion thread. Anyone can read; signed-in users can post,
// reply (one level deep), and edit/delete their own comments. Admins can
// delete any comment (moderation) — enforced by RLS, mirrored in the UI.
// Author names come from the public_profiles view (id + display_name only),
// since the profiles table itself is read-restricted to the owner.
export default function Discussion({ actorId }) {
  ...
  return (
    <div className="mt-12">
      <h2 className="text-2xl font-bold mb-4 text-yellow-400">
        Discussion {comments.length > 0 && <span className="text-gray-500 text-lg">({comments.length})</span>}
      </h2>
